...
use specs::prelude::*;
use crate::Pools;
use super::{Player, gamelog::GameLog, Map, Name, Position, State, InBackpack,
...
pub fn draw_ui(ecs: &World, ctx : &mut BTerm) {
    ...
    for (_player, stats, hc) in (&players, &combat_stats, &hunger).join() {
        ...
        ctx.draw_bar_horizontal(28, 43, 51, stats.hit_points.current, stats.hit_points.max, RGB::named(RED), RGB::named(BLACK));
